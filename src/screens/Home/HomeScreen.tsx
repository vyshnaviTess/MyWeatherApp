    ...
    <View style={styles.view}>
      <ScrollView>
        ...
        <View style={styles.placeView}>
          ...
          />
          <Title style={styles.tempInfo}>
            {Math.round(Number(info.temp))}°C
          </Title>
        ...
        <Card elevation={3} style={styles.card}>
          <Title style={styles.infoTitle}>
            min: {Math.round(Number(info.temp_min))}°C max:{' '}
            {Math.round(Number(info.temp_max))}°C
          </Title>
        </Card>
        <Card elevation={3} style={styles.card}>
